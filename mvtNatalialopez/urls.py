"""mvtNatalialopez URL Configuration
...
# from .views import bienvenidos, fecha
from . import views

urlpatterns = [
    path('bienvenidos/', views.bienvenidos),
    path('fecha/', views.fecha), 
    path('fecha-nacimiento/<int:edad>', views.calcular_facha_nacimiento),
